...
**Major changes**
- Feature
  - Add API bitcoinwallet.inscribeTransfer(ticker:string, amount:string)
...
- The displaying layout of NFTs in the extension is updated to match the layout on https://bitcoinswap.io/
