...
export const RESTORE_WALLETS: { value: RestoreWalletType; name: string; addressTypes: AddressType[] }[] = [
  {
    value: RestoreWalletType.BITCOINWALLET,
    name: 'Bitcoin Wallet',
    addressTypes: [
      AddressType.P2WPKH,
...
export const GITHUB_URL = 'https://github.com/bitcoin-swap/bitcoin-wallet';
export const DISCORD_URL = 'https://discord.gg/aJac9xUK';
